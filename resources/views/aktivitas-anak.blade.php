...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .benefit-card strong { color: #2d3748; }
        ...
        .bonus-box h4, .plr-box h4 {
            margin: 0 0 10px;
            font-size: 16px;
            font-weight: 900;
        }

        .bonus-box h4 { color: #c05621; }
        .bonus-box p { color: #7b341e; }
        ...
        @media (max-width: 360px) {
            ...
            .content-wrap { padding: 24px 14px 112px; }
            .slider-number-indicators [data-bs-target] {
                width: 30px;
                height: 30px;
                font-size: 13px;
        ...
        @media (min-width: 576px) {
            .content-wrap { padding: 35px 25px 122px; }
        }
    </style>
