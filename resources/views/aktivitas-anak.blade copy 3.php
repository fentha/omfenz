...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Fallback penting jika Bootstrap CDN belum termuat. */
        .p-2 {
        ...
        .price-box {
            ...
            margin: 30px 0;
            position: relative;
            box-shadow: 0 15px 35px rgba(221, 107, 32, .12);
        }
...
<body>
    ...
    <main class="mobile-page">
                    ...
                    <div class="carousel-item active">
                        <picture>
                            ...
                            <img src="{{ url('assets/aktivitas-anak/slider-baru-1.webp') }}"
                                alt="Promo 99.000 lembar aktivitas anak siap cetak harga Rp49.000" width="900"
        ...
        <section class="content-wrap">
            ...
            <p class="lead-copy">
                ...
                rumah tanpa harus beli buku satu-satu.
            </p>

            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/hbT_80wq1zQ?rel=0"
            ...
            <ul class="feature-list">
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <path d="M12 6v6l4 2"></path>
                            <circle cx="12" cy="12" r="9"></circle>
                        </svg></span><strong>Kids Planners:</strong> Melatih kemandirian dan manajemen waktu anak sejak
                    dini.</li>
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <path d="M4 19.5V5a2 2 0 0 1 2-2h12v18H6a2 2 0 0 1-2-1.5z"></path>
                            <path d="M8 7h6"></path>
                            <path d="M8 11h7"></path>
                        </svg></span><strong>Cerita Anak, Flashcard &amp; Poster:</strong> Visual menarik untuk
                    memaksimalkan daya ingat dan imajinasi.</li>
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <path d="M4 19h16"></path>
                            <path d="M7 16l5-12 5 12"></path>
                            <path d="M9 11h6"></path>
                        </svg></span><strong>Bahasa Inggris &amp; Menulis:</strong> Latihan menebalkan huruf, angka,
                    mewarnai, hingga <em>puzzle</em> asik.</li>
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <circle cx="6" cy="6" r="2"></circle>
                            <circle cx="6" cy="18" r="2"></circle>
                            <path d="M20 4 8 15"></path>
                            <path d="M8 9l12 11"></path>
                        </svg></span><strong>Origami &amp; Busy Book:</strong> Melatih motorik halus anak lewat
                    aktivitas seru menggunting dan menempel.</li>
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <path d="M9 3a4 4 0 0 0-4 4v10a4 4 0 0 0 4 4"></path>
                            <path d="M15 3a4 4 0 0 1 4 4v10a4 4 0 0 1-4 4"></path>
                            <path d="M9 7h6"></path>
                            <path d="M9 12h6"></path>
                            <path d="M9 17h6"></path>
                        </svg></span><strong>Worksheet Komprehensif:</strong> Alfabet, Matematika, Mencocokkan,
                    Teka-teki, Sains &amp; Membaca.</li>
                <li><span aria-hidden="true"><svg viewBox="0 0 24 24">
                            <circle cx="12" cy="12" r="9"></circle>
                            <path d="M3 12h18"></path>
                            <path d="M12 3a14 14 0 0 1 0 18"></path>
                            <path d="M12 3a14 14 0 0 0 0 18"></path>
                        </svg></span><strong>Mengenal Lingkungan:</strong> Hewan, Buah, Sayur, Profesi, Waktu,
                    Kendaraan, dll.</li>
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-sm-6">
                    <div class="benefit-card">
                        <p><strong>Praktis untuk Orang Tua</strong><br>Tinggal pilih materi, cetak, lalu pakai untuk
                            aktivitas anak di rumah.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="benefit-card">
                        <p><strong>Anak Tidak Cepat Bosan</strong><br>Materinya banyak, jadi aktivitas bisa diganti
                            sesuai mood dan usia anak.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="benefit-card">
                        <p><strong>Lebih Hemat</strong><br>Tidak perlu sering beli buku aktivitas satuan atau cari
                            worksheet gratis yang acak-acakan.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <div class="benefit-card">
            ...
            <div class="bonus-box">
                <h4>BONUS SPESIAL:</h4>
                <p class="mb-0">Termasuk Modul Kumon, Buku Mewarnai Dinosaurus, Kumpulan Cerita Anak, E-Book
                    Edukatif, dan bonus tambahan untuk aktivitas keluarga di rumah.</p>
            </div>
            ...
            <div class="guarantee-box">
                <strong>Aman setelah pembayaran:</strong> jika link produk tidak masuk email atau file sulit diakses,
            ...
            <div class="faq-list mb-4">
                <div class="faq-item">
                    ...
                    <p>Sama sekali tidak! File tersimpan rapi di Google Drive kami. Bunda tidak perlu download semuanya.
                        Cukup buka linknya dan download 1-2 lembar yang mau diprint hari ini.</p>
                </div>
                <div class="faq-item">
                    <strong>Nge-print 99.000 lembar bikin bangkrut beli tinta?</strong>
                    <p>Tidak harus diprint semua bund 😊. Ini adalah "stok seumur hidup". Print 1-2 lembar sehari saja.
                        Materi seperti flashcard dan poster juga bisa langsung dilihat dari HP/Tablet.</p>
                </div>
                <div class="faq-item">
                    <strong>Apakah gambarnya pecah kalau diprint?</strong>
                    <p>Tidak. File-file kami beresolusi tinggi (HD). Terlihat tajam dan cerah saat dicetak di kertas A4
                        standar sekalipun.</p>
                </div>
                <div class="faq-item">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var active = Math.max(0, items.findIndex(function(item) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var shareText =
                'Lihat paket 99.000++ lembar aktivitas anak siap cetak yang cocok untuk belajar sambil bermain.';
